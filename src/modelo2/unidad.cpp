...
int Unidad::atacar(Atacable* victima_){
    if (posicion.distancia_celda_a(victima_->get_posicion(),victima_->get_dimensiones())>unidad_base.get_rango())
...
bool Unidad::configurar_ataque(Atacable* victima_){
    std::cout << "la distancia es: " << posicion.distancia_celda_a(victima_->get_posicion(),victima_->get_dimensiones())<<std::endl;
